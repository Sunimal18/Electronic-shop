...
<body>
    ...
    <div class="row">
        <div class="container-fluid col-sm-6 col-lg-6 col-md-6 div-1 my-3 border border-warning border-3 rounded">
                <h1 class="text-center div-3">Edit Product</h1>
                <hr>
                <div class="container mt-8 col-sm-8 col-lg-8">
                    ...
                    <?php
                        ...
                        {
                    ?>
                        <form action="sql/editpost.php" class="form-control" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="id" id=""value="<?php echo $row["id"];?>">
                            <div class="form-floating mb-3">
                                 <input type="text" class="form-control" placeholder="Name" name="Product_name" value="<?php echo $row["name"];?>"required>
                                <label>Product Name</label>
                            </div>
                            <div class="form-floating mb-3">
                                 <input type="text" class="form-control" placeholder="Price" name="Price" value="<?php echo $row["price"];?>"required>
                                <label>Pricee</label>
                            </div>
                            <div class="form-floating mb-3">
                            ...
                            <div class="form-floating mb-3">
                                <textarea name="details" placeholder="description" cols="45" rows="15" class="form-control" required style="height:250px"><?php echo $row["details"];?></textarea>
